...
the [Fastvideo SDK](https://www.fastcompression.com/products/sdk.htm) and is licensed on a
commercial basis.
...
run locally: [2k_wild.ppm](https://www.fastcompression.com/img/test_j2k/2k_wild.ppm) and
