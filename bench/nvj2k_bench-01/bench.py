...
class Bench(object):
    ...
    def run(self, exe, args, log_name, power=None):
...
def main():
    ...
    write_results(b, outdir, codecs, quality, ref_size, checks, cross,
                  ...
                  scales=scales, watermark=watermark)
...
CSV_COLUMNS = ["codec", "direction", "image", "alg", "mode", "threads",
               "batch", "note", "frames", "boundary", "total_ms",
