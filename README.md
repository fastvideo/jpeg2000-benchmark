...
Published JPEG2000 numbers are hard to compare with each other. The format goes by two names —
JPEG2000 in the standard, J2K in most tools and file extensions — and the numbers published under
both are equally hard to line up.
...
The JPEG2000 (J2K) module of the Fastvideo SDK — a CUDA library for a full camera pipeline on the
GPU, licensed per platform: <https://www.fastcompression.com/products/gpu-jpeg2000.htm>
